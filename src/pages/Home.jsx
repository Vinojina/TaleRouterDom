      ...
      <div className="row">
        <div className="col-lg-7 align-self-center">
          <div className="caption  header-text">
            ...
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed doers eiusmod tempor incididunt ut la</p>
                      ...
                      <div>
                        <div className="row">
                          <div className="col-lg-7">
                            ...
                            <div className="line-dec"></div>
                            <p>Tale is the best SEO agency website template using Bootstrap v5.2.2 CSS for your c</p>
                            <div className="info">
                            ...
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed doers eiusmod tempor</p>
                          </div>
                          <div className="col-lg-5 align-self-center">
                            <img src={Client} alt="" />
                          </div>
                      ...
                      <div>
                        <div className="row">
                          <div className="col-lg-7">
                            ...
                            <div className="line-dec"></div>
                            <p>You are free to use this template for any purpose. You are not allowed to redistri</p>
                            <div className="info">
                              <span>HTML CSS</span>
                      ...
                      <div>
                        <div className="row">
                          <div className="col-lg-7">
                            ...
                            <div className="line-dec"></div>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed doers eiusmod kent te</p>
                            <div className="info">
                              <span>SEO Trend</span>
