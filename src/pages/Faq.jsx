        ...
        <div className="accordions is-first-expanded">
          <article className="accordion">
            ...
            <div className="accordion-body">
                        <div class="content">
                            <p>Tale is the best SEO agency website template using Bootstrap v5.2.2 CSS for your company. It is a free download provided by TemplateMo. There are 3 HTML pages, <a href="index.html">Home</a>, <a href="about.html">About</a>, and 
                            </p>
                        </div>
            </div>
          </article>
       ...
       <div className="get-free-quote">
         <form id="free-quote" method="submit" role="search" action="#">
           <div className="row">
             ...
             <div className="col-lg-12">
               <fieldset>
                 <input type="website" name="website" id="website" placeholder="Website URL" autocomplete="off" />
               </fieldset>
             </div>
             <div className="col-lg-12">
               <fieldset>
             ...
             <div className="col-lg-12">
               <fieldset>
                 <input type="full-name" name="full-name" id="full-name" placeholder="Full Name" autocomplete="off" />
               </fieldset>
             </div>
             <div className="col-lg-12">
               <fieldset>
